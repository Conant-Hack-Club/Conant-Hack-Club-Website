    ...
    return (
        <div className = "homeStyle" >
            ...
            <div className = "textBox">
                ...
                <h5 style={{margin:"16px"}}>Join us every Wednesday from 3:30 - 4:30 PM in the Media Center!</h5>
                <a href="/projects/2020-2021" style={{margin:"16px", color: "#338eda"}}>👉Click here to view our latest projects!👈</a>
